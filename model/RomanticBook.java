...
public class RomanticBook{
	...
	RomanticBook(String title) throws SQLException {
		String queryInsert = "INSERT INTO carti(titlu) VALUES ('" + title + "');";
		Statement statement = connection.createStatement();
		statement.executeUpdate(queryInsert);
		System.out.println("### Romantic Book added ###");
	}

	static void createConnection() throws SQLException {
		connection = DriverManager.getConnection("jdbc:postgresql://127.0.0.1:5432/BDRomantic", "postgres", "1q2w3e");
	}
